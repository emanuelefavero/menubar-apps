...
export default function Component({
  ...
  const baseStyles = clsx(
    'h-full px-3 py-2 text-sm font-medium select-none uppercase no-underline transition duration-250 backdrop-blur-[6px] border border-transparent active:scale-[0.97]',
  )
